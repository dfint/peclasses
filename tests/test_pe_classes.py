...
from peclasses.pe_classes import (
    ImageDosHeader, ImageFileHeader, ImageDataDirectory, ImageDataDirectoryArray, ImageOptionalHeader,
    ImageSectionHeader, ImageNTHeaders, ImageOptionalHeader64, ImageNTHeaders64
)
